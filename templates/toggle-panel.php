    <?php if ( is_active_sidebar( 'panel-parishes' ) ) : ?>
        <div id="parishes-toggle-nav" class="panel panel-parishes t-bg__grey">
    ...
    <?php if ( is_active_sidebar( 'panel-schools' ) ) : ?>
        <div id="schools-toggle-nav" class="panel panel-schools t-bg__grey">
            <div <?php hybrid_attr( 'wrap', 'u-pt' ); ?>>
                <?php hybrid_get_sidebar( 'panel-schools' ); ?>
            </div>
        </div>
    <?php endif; ?>
    <div id="dpc-toggle-nav" class="panel panel-dpc t-bg__grey">
