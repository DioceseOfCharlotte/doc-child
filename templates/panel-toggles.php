<div class="toggles">
    <?php if ( is_active_sidebar( 'panel-parishes' ) ) : ?>
        <div id="parish-toggle" class="toggle link" title="<?php esc_attr_e( 'Parishes', 'doc' ); ?>">
    ...
    <?php if ( is_active_sidebar( 'panel-schools' ) ) : ?>
        <div id="schools-toggle" class="toggle link" title="<?php esc_attr_e( 'Schools', 'doc' ); ?>">
            <?php get_template_part( 'images/vector/svg', 'school' ); ?>
            <span class="toggle-title"><?php _e( 'Schools', 'doc' ); ?></span>
        </div><!-- #schools-toggle -->
    <?php endif; ?>
    <div id="dpc-toggle" class="toggle link" title="<?php esc_attr_e( 'Pastoral Center', 'doc' ); ?>">
        <?php get_template_part( 'images/vector/svg', 'library' ); ?>
        <span class="toggle-title"><?php _e( 'Pastoral Center', 'doc' ); ?></span>
    </div><!-- #dpc-toggle -->
    <div id="search-toggle" class="toggle link" title="<?php esc_attr_e( 'Search', 'doc' ); ?>">
        <?php get_template_part( 'images/vector/svg', 'search' ); ?>
