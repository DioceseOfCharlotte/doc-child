<div class="toggles u-ph-">
    ...
    <?php if ( is_active_sidebar( 'panel-schools' ) ) : ?>
        <div id="schools-toggle" class="toggle button button--tab" title="<?php esc_attr_e( 'Schools', 'doc' ); ?>">
            <?php get_template_part( 'images/vector/svg', 'school' ); ?>
            <span class="toggle-title"><?php _e( 'Schools', 'doc' ); ?></span>
        </div><!-- #schools-toggle -->
    <?php endif; ?>
    <div id="dpc-toggle" class="toggle button button--tab" title="<?php esc_attr_e( 'Pastoral Center', 'doc' ); ?>">
